...
def get_flashattention_autograd_function_triton() -> Type:
    ...
    Returns:
        A class object (not an instance of the class)
    """
    if FlashAttnTritonFunc is None:
        raise ImportError("Triton is not installed. Install it to use the Triton implementation.")
    return FlashAttnTritonFunc
